...
const parseInstagramPost = (text: string): string | JSX.Element | JSX.Element[] => {
  const urlRegex =
  ...
  parsedtext = parsedtext.replace(
    mentionRegex,
    (mention) =>
      '<a class="underline" target="_blank" href="https://www.instagram.com/' +
      mention.slice(1) +
      '">' +
      mention +
      '</a>'
  ...
  parsedtext = parsedtext.replace(
    hashtagRegex,
    (hashtag) =>
      '<a class="underline" target="_blank" href="https://www.instagram.com/explore/tags/' +
      hashtag.slice(1) +
      '">' +
      hashtag +
      '</a>'
...
export default parseInstagramPost;
